...
function AccumulatorPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AccumulatorPage.useEffect": ()=>{
            let cancelled = false;
            const base = ("TURBOPACK compile-time value", "/accumulators") ?? '';
            fetch(`${base}/app-config.json`).then({
                "AccumulatorPage.useEffect": (response)=>response.ok ? response.json() : null
            }["AccumulatorPage.useEffect"]).then({
                "AccumulatorPage.useEffect": (data)=>{
            ...
            }["AccumulatorPage.useEffect"]).catch({
                "AccumulatorPage.useEffect": ()=>{
...
_s(AccumulatorPage, "0CZYlEQiEontFHQCAsAQurOdlIs=");
_c = AccumulatorPage;
var _c;
__turbopack_context__.k.register(_c, "AccumulatorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0hodpt7._.js.map