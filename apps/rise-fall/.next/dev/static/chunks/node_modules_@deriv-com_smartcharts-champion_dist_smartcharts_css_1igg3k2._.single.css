/* [project]/node_modules/@deriv-com/smartcharts-champion/dist/smartcharts.css [app-client] (css) */
.ic-icon {
...
.smartcharts-dark .sc-chart-mode__menu__interval, .smartcharts-light .sc-chart-mode__menu__interval {
  color: #fff;
  background: #414652;
}
...
.sc-tooltip--bottom .sc-tooltip__inner {
  top: 100%;
  transform: translateX(-50%)translateY(8px);
}

.sc-tooltip--bottom .sc-tooltip__inner:before {
  top: 0;
  bottom: auto;
  transform: translateY(-100%);
...
.smartcharts-light .sc-tooltip--bottom .sc-tooltip__inner:before {
  border-bottom: 6px solid #d6dadb;
}

.smartcharts-dark .sc-tooltip--bottom .sc-tooltip__inner:before {
  border-bottom: 6px solid #323738;
}
...
.chart-line--inline-label .price-line-inline__line {
  border-top-width: 1px;
  flex: auto;
  min-width: 0;
  height: 0;
...
.chart-line--inline-label .price-line-inline__label-row {
  white-space: nowrap;
  flex: none;
  align-items: center;
  gap: 2px;
...
.chart-line--inline-label .price-line-inline__chevron {
  flex-shrink: 0;
}

.chart-line--inline-label .price-line-inline__title {
  padding: 0 4px;
}

.chart-line--inline-label .price-line-inline__pill {
...
.smartcharts-light .sc-navigation-widget__item {
  background-color: #0000000a;
}

.smartcharts-dark .sc-navigation-widget__item {
  background-color: #ffffff0a;
}

.smartcharts-light .sc-navigation-widget__item:hover {
  background-color: #00000014;
}

.smartcharts-dark .sc-navigation-widget__item:hover {
  background-color: #ffffff1f;
}

.sc-navigation-widget__item:focus {
  outline: none;
}

.sc-navigation-widget__item:focus-visible {
  outline-offset: 2px;
}

.smartcharts-light .sc-navigation-widget__item:focus-visible {
  outline: 2px solid #000000b8;
}

.smartcharts-dark .sc-navigation-widget__item:focus-visible {
...
.sc-navigation-widget__item .ic-icon svg {
  stroke: none;
  width: 24px;
  height: 24px;
}
...
.sc-navigation-widget__item--disabled, .sc-navigation-widget__item:disabled {
  opacity: .5;
  pointer-events: none;
}

.sc-navigation-widget .sc-crosshair-toggle, .sc-navigation-widget .sc-scale-toggle {
  display: flex;
  position: relative;
}

.sc-navigation-widget .sc-scale-toggle--hidden {
  display: none;
}

.sc-navigation-widget--indent {
  bottom: 78px;
}
...
.sc-toolbar-widget .ciq-menu {
  min-height: 0;
}

.sc-toolbar-widget .ciq-menu .cq-menu-btn {
  height: auto;
  padding: 0;
}
...
.smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu {
  background: #0000000a;
}

.smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu {
  background: #ffffff0a;
}
...
.sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu .sc-notification-badge, .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu .sc-notification-badge, .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu .sc-notification-badge, .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu .sc-notification-badge, .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu .sc-notification-badge {
  width: 8px;
  min-width: 8px;
  height: 8px;
  font-size: 0;
...
.smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-chart-mode__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-download__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-dtools__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-studies__menu, .smartcharts-light .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-views__menu {
  background: #00000014;
}

.smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-chart-mode__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-download__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-dtools__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-studies__menu, .smartcharts-dark .sc-toolbar-widget .ciq-menu .cq-menu-btn:hover .sc-views__menu {
  background: #ffffff1f;
}
...
.sc-toolbar-widget--bottom, .sc-toolbar-widget--left, .sc-toolbar-widget--top {
  top: auto;
  bottom: 48px;
  left: 16px;
}
...
.smartcharts-mobile .sc-toolbar-widget__items {
  z-index: 1;
  width: 40px;
  position: absolute;
  bottom: 44px;
...
.smartcharts-mobile .sc-toolbar-widget__items-inner {
  pointer-events: none;
  flex-direction: column;
  align-items: center;
  display: flex;
...
.smartcharts-mobile .sc-toolbar-widget__items-inner > :nth-last-child(2) {
  --sc-tb-travel: 96px;
}

.smartcharts-mobile .sc-toolbar-widget__items-inner > :nth-last-child(3) {
  --sc-tb-travel: 144px;
}

.smartcharts-mobile .sc-toolbar-widget__items-inner > :nth-last-child(4) {
  --sc-tb-travel: 192px;
}

.smartcharts-mobile .sc-toolbar-widget__items-inner .sc-chart-mode__menu, .smartcharts-mobile .sc-toolbar-widget__items-inner .sc-download__menu, .smartcharts-mobile .sc-toolbar-widget__items-inner .sc-dtools__menu, .smartcharts-mobile .sc-toolbar-widget__items-inner .sc-studies__menu, .smartcharts-mobile .sc-toolbar-widget__items-inner .sc-views__menu {
  opacity: 0;
  transform: translateY(48px);
  transform: translateY(var(--sc-tb-travel, 48px));
  transition: transform .26s cubic-bezier(.55, .06, .68, .19), opacity .26s cubic-bezier(.55, .06, .68, .19);
}

.smartcharts-mobile .sc-toolbar-widget__more {
  -webkit-backdrop-filter: blur(8px);
  box-shadow: none;
  box-sizing: border-box;
  cursor: pointer;
...
.smartcharts-light .smartcharts-mobile .sc-toolbar-widget__more {
  background: #0000000a;
}

.smartcharts-dark .smartcharts-mobile .sc-toolbar-widget__more {
  background: #ffffff0a;
}

.smartcharts-mobile .sc-toolbar-widget__more .ic-icon {
  top: 0;
  width: 24px !important;
  height: 24px !important;
}

.smartcharts-mobile .sc-toolbar-widget__more .ic-icon svg {
  stroke: none;
  position: relative;
  bottom: 0;
  width: 24px !important;
...
.smartcharts-light .smartcharts-mobile .sc-toolbar-widget__more .ic-icon svg {
  fill: #000000b8;
}

.smartcharts-dark .smartcharts-mobile .sc-toolbar-widget__more .ic-icon svg {
  fill: #ffffffb8;
}

.smartcharts-mobile .sc-toolbar-widget__more .sc-notification-badge {
  width: 8px;
  min-width: 8px;
  height: 8px;
  font-size: 0;
...
.smartcharts-mobile .sc-toolbar-widget__interval {
  -webkit-backdrop-filter: blur(4px);
  pointer-events: none;
  text-align: center;
  text-transform: lowercase;
...
.smartcharts-dark .smartcharts-mobile .sc-toolbar-widget__interval, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget__interval {
  color: #fff;
  background: #414652;
}

.smartcharts-mobile .sc-toolbar-widget--expanded .sc-toolbar-widget__items-inner {
  pointer-events: auto;
}

.smartcharts-mobile .sc-toolbar-widget--expanded .sc-toolbar-widget__items-inner .sc-chart-mode__menu, .smartcharts-mobile .sc-toolbar-widget--expanded .sc-toolbar-widget__items-inner .sc-download__menu, .smartcharts-mobile .sc-toolbar-widget--expanded .sc-toolbar-widget__items-inner .sc-dtools__menu, .smartcharts-mobile .sc-toolbar-widget--expanded .sc-toolbar-widget__items-inner .sc-studies__menu, .smartcharts-mobile .sc-toolbar-widget--expanded .sc-toolbar-widget__items-inner .sc-views__menu {
  opacity: 1;
  transition: transform .26s cubic-bezier(.22, .61, .36, 1), opacity .26s cubic-bezier(.22, .61, .36, 1);
  transform: translateY(0);
}

.smartcharts-mobile .sc-toolbar-widget--expanded .sc-toolbar-widget__interval {
  opacity: 0;
}

.smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu {
  -webkit-backdrop-filter: blur(8px);
  box-shadow: none;
  box-sizing: border-box;
  border: none;
...
.smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu {
  background: #0000000a;
}

.smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu {
  background: #ffffff0a;
}

.smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu .ic-icon, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu .ic-icon, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu .ic-icon, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu .ic-icon, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu .ic-icon {
  top: 0;
  width: 24px !important;
  height: 24px !important;
}

.smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu .ic-icon svg, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu .ic-icon svg, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu .ic-icon svg, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu .ic-icon svg, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu .ic-icon svg {
  stroke: none;
  position: relative;
  bottom: 0;
  width: 24px !important;
...
.smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu .ic-icon svg, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu .ic-icon svg, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu .ic-icon svg, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu .ic-icon svg, .smartcharts-light .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu .ic-icon svg {
  fill: #000000b8;
}

.smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu .ic-icon svg, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu .ic-icon svg, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu .ic-icon svg, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu .ic-icon svg, .smartcharts-dark .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu .ic-icon svg {
  fill: #ffffffb8;
}

.smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-chart-mode__menu .sc-notification-badge, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-download__menu .sc-notification-badge, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-dtools__menu .sc-notification-badge, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-studies__menu .sc-notification-badge, .smartcharts-mobile .sc-toolbar-widget .ciq-menu .cq-menu-btn .sc-views__menu .sc-notification-badge {
  width: 8px;
  min-width: 8px;
  height: 8px;
  font-size: 0;
...
/*# sourceMappingURL=node_modules_%40deriv-com_smartcharts-champion_dist_smartcharts_css_1igg3k2._.single.css.map*/